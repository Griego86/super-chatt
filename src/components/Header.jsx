    ...
    return (
        <header className="sticky z-50 top-0 md:flex justify-between py-5 bg-indigo-600 text-white">
            {expandedMenu && <div className="flex flex-col md:flex-row">
                <NavLink to="/capychat/" className="text-center py-2 md:py-4 px-5">Super Chatt</NavLink>
            ...
            <div className="flex justify-between md:hidden">
                {!expandedMenu && <NavLink to="/capychat/" className="py-2 px-2 md:hidden"><div className="flex">Super Chatt</div></NavLink>}
